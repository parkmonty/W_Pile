...
class Bicycle(Vehicle):
    ...
    def speed(self, speed):
        self._speed = speed if 0 <= speed <= Bicycle.max else 0
...
class NormalCar(Vehicle):
    ...
    @speed.setter
    def speed(self, speed):
        self._speed = speed if 0 <= speed <= self.max else 0
